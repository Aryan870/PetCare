    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={() => speciality === 'Radiology/Diagnostic Imaging' ? navigate('/doctors') : navigate('/doctors/Radiology')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Radiology/Diagnostic Imaging' ? 'bg-indigo-100 text-black ' : ''}`}>Radiology/Diagnostic Imaging</p>
          <p onClick={() => speciality === 'Emergency and Critical Care' ? navigate('/doctors') : navigate('/doctors/Emergency')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Emergency and Critical Care' ? 'bg-indigo-100 text-black ' : ''}`}>Emergency and Critical Care</p>
        </div>
